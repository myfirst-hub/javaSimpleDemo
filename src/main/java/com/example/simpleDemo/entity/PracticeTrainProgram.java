...
public class PracticeTrainProgram {
    private Long id;
    private String name;
    ...
    // Constructors
    public PracticeTrainProgram() {
    }

    public PracticeTrainProgram(Long id, String name, String semester, String trainDescribe, BigDecimal trainTime,
